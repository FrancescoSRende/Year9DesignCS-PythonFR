...
os.system("say -v Milena Hello! Welcome to my slope calculator!")
#Input - CHANGE
x1 = input("Input x1: ")
x1 = int(x1) #casting
...
os.system("say -v Milena Your slope is m = "+str(rise)+"/"+str(run))
print("Your slope as a decimal is ",fSlope)
os.system("say -v Milena Your slope as a decimal is "+str(fSlope))
print("The rise is "+str(rise))
print("The rise is "+str(run))
#change